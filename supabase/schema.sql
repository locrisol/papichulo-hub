...
CREATE POLICY "restaurants_all_super_admin" ON "public"."restaurants" USING (("public"."get_my_role"() = 'super_admin'::"text")) WITH CHECK (("public"."get_my_role"() = 'super_admin'::"text"));

CREATE POLICY "restaurants_select" ON "public"."restaurants" FOR SELECT USING ((("public"."get_my_role"() = 'super_admin'::"text") OR (("public"."get_my_role"() = ANY (ARRAY['owner'::"text", 'store_manager'::"text"])) AND ("id" = "public"."get_my_restaurant_id"()))));

CREATE POLICY "restaurants_select_own" ON "public"."restaurants" FOR SELECT USING ((("public"."get_my_role"() = 'employee'::"text") AND ("id" = "public"."get_my_restaurant_id"())));

CREATE POLICY "restaurants_update_own" ON "public"."restaurants" FOR UPDATE USING ((("public"."get_my_role"() = 'store_manager'::"text") AND ("id" = "public"."get_my_restaurant_id"()))) WITH CHECK ((("public"."get_my_role"() = 'store_manager'::"text") AND ("id" = "public"."get_my_restaurant_id"())));

ALTER TABLE "public"."users" ENABLE ROW LEVEL SECURITY;

CREATE POLICY "users_select" ON "public"."users" FOR SELECT USING ((("public"."get_my_role"() = 'super_admin'::"text") OR (("public"."get_my_role"() = 'owner'::"text") AND ("restaurant_id" = "public"."get_my_restaurant_id"())) OR (("public"."get_my_role"() = 'store_manager'::"text") AND ("restaurant_id" = "public"."get_my_restaurant_id"()))));

CREATE POLICY "users_select_own" ON "public"."users" FOR SELECT USING (("id" = "auth"."uid"()));

CREATE POLICY "users_write" ON "public"."users" USING ((("public"."get_my_role"() = 'super_admin'::"text") OR (("public"."get_my_role"() = 'owner'::"text") AND ("restaurant_id" = "public"."get_my_restaurant_id"()) AND ("role" IN ('store_manager', 'employee'))) OR (("public"."get_my_role"() = 'store_manager'::"text") AND ("restaurant_id" = "public"."get_my_restaurant_id"()) AND (("role")::"text" = 'employee'::"text")))) WITH CHECK ((("public"."get_my_role"() = 'super_admin'::"text") OR (("public"."get_my_role"() = 'owner'::"text") AND ("restaurant_id" = "public"."get_my_restaurant_id"()) AND ("role" IN ('store_manager', 'employee'))) OR (("public"."get_my_role"() = 'store_manager'::"text") AND ("restaurant_id" = "public"."get_my_restaurant_id"()) AND (("role")::"text" = 'employee'::"text"))));

ALTER TABLE "public"."positions" ENABLE ROW LEVEL SECURITY;

CREATE POLICY "positions_all" ON "public"."positions" USING ((("public"."get_my_role"() = 'super_admin'::"text") OR (("public"."get_my_role"() = ANY (ARRAY['owner'::"text", 'store_manager'::"text"])) AND ("restaurant_id" = "public"."get_my_restaurant_id"())))) WITH CHECK ((("public"."get_my_role"() = 'super_admin'::"text") OR (("public"."get_my_role"() = ANY (ARRAY['owner'::"text", 'store_manager'::"text"])) AND ("restaurant_id" = "public"."get_my_restaurant_id"()))));

ALTER TABLE "public"."employees" ENABLE ROW LEVEL SECURITY;

CREATE POLICY "employees_all" ON "public"."employees" USING ((("public"."get_my_role"() = 'super_admin'::"text") OR (("public"."get_my_role"() = ANY (ARRAY['owner'::"text", 'store_manager'::"text"])) AND ("restaurant_id" = "public"."get_my_restaurant_id"())))) WITH CHECK ((("public"."get_my_role"() = 'super_admin'::"text") OR (("public"."get_my_role"() = ANY (ARRAY['owner'::"text", 'store_manager'::"text"])) AND ("restaurant_id" = "public"."get_my_restaurant_id"()))));
...
CREATE POLICY "suppliers_select" ON "public"."suppliers" FOR SELECT USING (("public"."get_my_role"() = ANY (ARRAY['super_admin'::"text", 'owner'::"text", 'store_manager'::"text", 'employee'::"text"])));

CREATE POLICY "suppliers_write" ON "public"."suppliers" USING (("public"."get_my_role"() = ANY (ARRAY['super_admin'::"text", 'owner'::"text", 'store_manager'::"text"]))) WITH CHECK (("public"."get_my_role"() = ANY (ARRAY['super_admin'::"text", 'owner'::"text", 'store_manager'::"text"])));

ALTER TABLE "public"."products" ENABLE ROW LEVEL SECURITY;

CREATE POLICY "products_select" ON "public"."products" FOR SELECT USING (("public"."get_my_role"() = ANY (ARRAY['super_admin'::"text", 'owner'::"text", 'store_manager'::"text", 'employee'::"text"])));

CREATE POLICY "products_write" ON "public"."products" USING (("public"."get_my_role"() = ANY (ARRAY['super_admin'::"text", 'owner'::"text", 'store_manager'::"text"]))) WITH CHECK (("public"."get_my_role"() = ANY (ARRAY['super_admin'::"text", 'owner'::"text", 'store_manager'::"text"])));

ALTER TABLE "public"."product_supplier_prices" ENABLE ROW LEVEL SECURITY;

CREATE POLICY "product_supplier_prices_select" ON "public"."product_supplier_prices" FOR SELECT USING ((("public"."get_my_role"() = 'super_admin'::"text") OR (("public"."get_my_role"() = ANY (ARRAY['owner'::"text", 'store_manager'::"text", 'employee'::"text"])) AND ("restaurant_id" = "public"."get_my_restaurant_id"()))));

CREATE POLICY "product_supplier_prices_write" ON "public"."product_supplier_prices" USING ((("public"."get_my_role"() = 'super_admin'::"text") OR (("public"."get_my_role"() = ANY (ARRAY['owner'::"text", 'store_manager'::"text"])) AND ("restaurant_id" = "public"."get_my_restaurant_id"())))) WITH CHECK ((("public"."get_my_role"() = 'super_admin'::"text") OR (("public"."get_my_role"() = ANY (ARRAY['owner'::"text", 'store_manager'::"text"])) AND ("restaurant_id" = "public"."get_my_restaurant_id"()))));

ALTER TABLE "public"."price_count_units" ENABLE ROW LEVEL SECURITY;

CREATE POLICY "price_count_units_read" ON "public"."price_count_units" FOR SELECT USING ((("public"."get_my_role"() = 'super_admin'::"text") OR (EXISTS ( SELECT 1
   FROM "public"."product_supplier_prices" "psp"
  WHERE (("psp"."id" = "price_count_units"."price_id") AND ("psp"."restaurant_id" = "public"."get_my_restaurant_id"()))))));

CREATE POLICY "price_count_units_write" ON "public"."price_count_units" USING ((("public"."get_my_role"() = 'super_admin'::"text") OR (EXISTS ( SELECT 1
   FROM "public"."product_supplier_prices" "psp"
  WHERE (("psp"."id" = "price_count_units"."price_id") AND ("public"."get_my_role"() = ANY (ARRAY['owner'::"text", 'store_manager'::"text"])) AND ("psp"."restaurant_id" = "public"."get_my_restaurant_id"())))))) WITH CHECK ((("public"."get_my_role"() = 'super_admin'::"text") OR (EXISTS ( SELECT 1
   FROM "public"."product_supplier_prices" "psp"
  WHERE (("psp"."id" = "price_count_units"."price_id") AND ("public"."get_my_role"() = ANY (ARRAY['owner'::"text", 'store_manager'::"text"])) AND ("psp"."restaurant_id" = "public"."get_my_restaurant_id"()))))));

ALTER TABLE "public"."product_aliases" ENABLE ROW LEVEL SECURITY;

CREATE POLICY "product_aliases_select" ON "public"."product_aliases" FOR SELECT USING (("public"."get_my_role"() = ANY (ARRAY['super_admin'::"text", 'owner'::"text", 'store_manager'::"text"])));

CREATE POLICY "product_aliases_write" ON "public"."product_aliases" USING (("public"."get_my_role"() = ANY (ARRAY['super_admin'::"text", 'owner'::"text", 'store_manager'::"text"]))) WITH CHECK (("public"."get_my_role"() = ANY (ARRAY['super_admin'::"text", 'owner'::"text", 'store_manager'::"text"])));

ALTER TABLE "public"."mix_recipes" ENABLE ROW LEVEL SECURITY;

CREATE POLICY "mix_recipes_select" ON "public"."mix_recipes" FOR SELECT USING (("public"."get_my_role"() = ANY (ARRAY['super_admin'::"text", 'owner'::"text", 'store_manager'::"text"])));

CREATE POLICY "mix_recipes_write" ON "public"."mix_recipes" USING (("public"."get_my_role"() = ANY (ARRAY['super_admin'::"text", 'owner'::"text", 'store_manager'::"text"]))) WITH CHECK (("public"."get_my_role"() = ANY (ARRAY['super_admin'::"text", 'owner'::"text", 'store_manager'::"text"])));

ALTER TABLE "public"."product_allergens" ENABLE ROW LEVEL SECURITY;

CREATE POLICY "product_allergens_select" ON "public"."product_allergens" FOR SELECT USING (("public"."get_my_role"() = ANY (ARRAY['super_admin'::"text", 'owner'::"text", 'store_manager'::"text", 'employee'::"text"])));

CREATE POLICY "product_allergens_write" ON "public"."product_allergens" USING (("public"."get_my_role"() = ANY (ARRAY['super_admin'::"text", 'owner'::"text", 'store_manager'::"text"]))) WITH CHECK (("public"."get_my_role"() = ANY (ARRAY['super_admin'::"text", 'owner'::"text", 'store_manager'::"text"])));
...
CREATE POLICY "menu_categories_select" ON "public"."menu_categories" FOR SELECT USING (("public"."get_my_role"() = ANY (ARRAY['super_admin'::"text", 'owner'::"text", 'store_manager'::"text", 'employee'::"text"])));

CREATE POLICY "menu_categories_write" ON "public"."menu_categories" USING (("public"."get_my_role"() = ANY (ARRAY['super_admin'::"text", 'owner'::"text", 'store_manager'::"text"]))) WITH CHECK (("public"."get_my_role"() = ANY (ARRAY['super_admin'::"text", 'owner'::"text", 'store_manager'::"text"])));

ALTER TABLE "public"."menu_items" ENABLE ROW LEVEL SECURITY;

CREATE POLICY "menu_items_select" ON "public"."menu_items" FOR SELECT USING (("public"."get_my_role"() = ANY (ARRAY['super_admin'::"text", 'owner'::"text", 'store_manager'::"text", 'employee'::"text"])));

CREATE POLICY "menu_items_write" ON "public"."menu_items" USING (("public"."get_my_role"() = ANY (ARRAY['super_admin'::"text", 'owner'::"text", 'store_manager'::"text"]))) WITH CHECK (("public"."get_my_role"() = ANY (ARRAY['super_admin'::"text", 'owner'::"text", 'store_manager'::"text"])));

ALTER TABLE "public"."menu_item_components" ENABLE ROW LEVEL SECURITY;

CREATE POLICY "menu_item_components_select" ON "public"."menu_item_components" FOR SELECT USING (("public"."get_my_role"() = ANY (ARRAY['super_admin'::"text", 'owner'::"text", 'store_manager'::"text", 'employee'::"text"])));

CREATE POLICY "menu_item_components_write" ON "public"."menu_item_components" USING (("public"."get_my_role"() = ANY (ARRAY['super_admin'::"text", 'owner'::"text", 'store_manager'::"text"]))) WITH CHECK (("public"."get_my_role"() = ANY (ARRAY['super_admin'::"text", 'owner'::"text", 'store_manager'::"text"])));
...
CREATE POLICY "sales_records_select" ON "public"."sales_records" FOR SELECT USING ((("public"."get_my_role"() = 'super_admin'::"text") OR (("public"."get_my_role"() = ANY (ARRAY['owner'::"text", 'store_manager'::"text"])) AND ("restaurant_id" = "public"."get_my_restaurant_id"()))));

CREATE POLICY "sales_records_write" ON "public"."sales_records" USING ((("public"."get_my_role"() = 'super_admin'::"text") OR (("public"."get_my_role"() = ANY (ARRAY['owner'::"text", 'store_manager'::"text"])) AND ("restaurant_id" = "public"."get_my_restaurant_id"())))) WITH CHECK ((("public"."get_my_role"() = 'super_admin'::"text") OR (("public"."get_my_role"() = ANY (ARRAY['owner'::"text", 'store_manager'::"text"])) AND ("restaurant_id" = "public"."get_my_restaurant_id"()))));

ALTER TABLE "public"."sales_tenders" ENABLE ROW LEVEL SECURITY;

CREATE POLICY "sales_tenders_select" ON "public"."sales_tenders" FOR SELECT USING ((("public"."get_my_role"() = 'super_admin'::"text") OR (("public"."get_my_role"() = ANY (ARRAY['owner'::"text", 'store_manager'::"text"])) AND ("restaurant_id" = "public"."get_my_restaurant_id"()))));

CREATE POLICY "sales_tenders_write" ON "public"."sales_tenders" USING (("public"."get_my_role"() = 'super_admin'::"text")) WITH CHECK (("public"."get_my_role"() = 'super_admin'::"text"));

ALTER TABLE "public"."sales_platforms" ENABLE ROW LEVEL SECURITY;

CREATE POLICY "sales_platforms_select" ON "public"."sales_platforms" FOR SELECT USING ((("public"."get_my_role"() = 'super_admin'::"text") OR (("public"."get_my_role"() = ANY (ARRAY['owner'::"text", 'store_manager'::"text"])) AND ("restaurant_id" = "public"."get_my_restaurant_id"()))));
...
CREATE POLICY "petty_cash_select" ON "public"."petty_cash_entries" FOR SELECT USING ((("public"."get_my_role"() = 'super_admin'::"text") OR (("public"."get_my_role"() = ANY (ARRAY['owner'::"text", 'store_manager'::"text"])) AND ("restaurant_id" = "public"."get_my_restaurant_id"()))));

CREATE POLICY "petty_cash_write" ON "public"."petty_cash_entries" USING ((("public"."get_my_role"() = 'super_admin'::"text") OR (("public"."get_my_role"() = ANY (ARRAY['owner'::"text", 'store_manager'::"text"])) AND ("restaurant_id" = "public"."get_my_restaurant_id"())))) WITH CHECK ((("public"."get_my_role"() = 'super_admin'::"text") OR (("public"."get_my_role"() = ANY (ARRAY['owner'::"text", 'store_manager'::"text"])) AND ("restaurant_id" = "public"."get_my_restaurant_id"()))));

ALTER TABLE "public"."predictions" ENABLE ROW LEVEL SECURITY;

CREATE POLICY "predictions_select" ON "public"."predictions" FOR SELECT USING ((("public"."get_my_role"() = 'super_admin'::"text") OR (("public"."get_my_role"() = ANY (ARRAY['owner'::"text", 'store_manager'::"text"])) AND ("restaurant_id" = "public"."get_my_restaurant_id"()))));

CREATE POLICY "predictions_write" ON "public"."predictions" USING (("public"."get_my_role"() = 'super_admin'::"text")) WITH CHECK (("public"."get_my_role"() = 'super_admin'::"text"));
...
CREATE POLICY "invoices_select" ON "public"."invoices" FOR SELECT USING ((("public"."get_my_role"() = 'super_admin'::"text") OR (("public"."get_my_role"() = ANY (ARRAY['owner'::"text", 'store_manager'::"text"])) AND ("restaurant_id" = "public"."get_my_restaurant_id"()))));

CREATE POLICY "invoices_write" ON "public"."invoices" USING ((("public"."get_my_role"() = 'super_admin'::"text") OR (("public"."get_my_role"() = ANY (ARRAY['owner'::"text", 'store_manager'::"text"])) AND ("restaurant_id" = "public"."get_my_restaurant_id"())))) WITH CHECK ((("public"."get_my_role"() = 'super_admin'::"text") OR (("public"."get_my_role"() = ANY (ARRAY['owner'::"text", 'store_manager'::"text"])) AND ("restaurant_id" = "public"."get_my_restaurant_id"()))));

ALTER TABLE "public"."invoice_lines" ENABLE ROW LEVEL SECURITY;

CREATE POLICY "invoice_lines_select" ON "public"."invoice_lines" FOR SELECT USING ((("public"."get_my_role"() = 'super_admin'::"text") OR (EXISTS ( SELECT 1
   FROM "public"."invoices" "i"
  WHERE (("i"."id" = "invoice_lines"."invoice_id") AND (("public"."get_my_role"() = ANY (ARRAY['owner'::"text", 'store_manager'::"text"])) AND ("i"."restaurant_id" = "public"."get_my_restaurant_id"())))))));

CREATE POLICY "invoice_lines_write" ON "public"."invoice_lines" USING ((("public"."get_my_role"() = 'super_admin'::"text") OR (EXISTS ( SELECT 1
   FROM "public"."invoices" "i"
  WHERE (("i"."id" = "invoice_lines"."invoice_id") AND (("public"."get_my_role"() = ANY (ARRAY['owner'::"text", 'store_manager'::"text"])) AND ("i"."restaurant_id" = "public"."get_my_restaurant_id"()))))))) WITH CHECK ((("public"."get_my_role"() = 'super_admin'::"text") OR (EXISTS ( SELECT 1
   FROM "public"."invoices" "i"
  WHERE (("i"."id" = "invoice_lines"."invoice_id") AND (("public"."get_my_role"() = ANY (ARRAY['owner'::"text", 'store_manager'::"text"])) AND ("i"."restaurant_id" = "public"."get_my_restaurant_id"())))))));

ALTER TABLE "public"."labour_entries" ENABLE ROW LEVEL SECURITY;

CREATE POLICY "labour_entries_select" ON "public"."labour_entries" FOR SELECT USING ((("public"."get_my_role"() = 'super_admin'::"text") OR (("public"."get_my_role"() = ANY (ARRAY['owner'::"text", 'store_manager'::"text"])) AND ("restaurant_id" = "public"."get_my_restaurant_id"()))));

CREATE POLICY "labour_entries_write" ON "public"."labour_entries" USING ((("public"."get_my_role"() = 'super_admin'::"text") OR (("public"."get_my_role"() = ANY (ARRAY['owner'::"text", 'store_manager'::"text"])) AND ("restaurant_id" = "public"."get_my_restaurant_id"())))) WITH CHECK ((("public"."get_my_role"() = 'super_admin'::"text") OR (("public"."get_my_role"() = ANY (ARRAY['owner'::"text", 'store_manager'::"text"])) AND ("restaurant_id" = "public"."get_my_restaurant_id"()))));

ALTER TABLE "public"."cost_target_overrides" ENABLE ROW LEVEL SECURITY;

CREATE POLICY "cost_target_overrides_select" ON "public"."cost_target_overrides" FOR SELECT USING ((("public"."get_my_role"() = 'super_admin'::"text") OR (("public"."get_my_role"() = ANY (ARRAY['owner'::"text", 'store_manager'::"text"])) AND ("restaurant_id" = "public"."get_my_restaurant_id"()))));

CREATE POLICY "cost_target_overrides_write" ON "public"."cost_target_overrides" USING ((("public"."get_my_role"() = 'super_admin'::"text") OR (("public"."get_my_role"() = ANY (ARRAY['owner'::"text", 'store_manager'::"text"])) AND ("restaurant_id" = "public"."get_my_restaurant_id"())))) WITH CHECK ((("public"."get_my_role"() = 'super_admin'::"text") OR (("public"."get_my_role"() = ANY (ARRAY['owner'::"text", 'store_manager'::"text"])) AND ("restaurant_id" = "public"."get_my_restaurant_id"()))));

ALTER TABLE "public"."waste_logs" ENABLE ROW LEVEL SECURITY;

CREATE POLICY "waste_logs_insert" ON "public"."waste_logs" FOR INSERT WITH CHECK ((("public"."get_my_role"() = ANY (ARRAY['super_admin'::"text", 'owner'::"text", 'store_manager'::"text", 'employee'::"text"])) AND ("restaurant_id" = "public"."get_my_restaurant_id"())));

CREATE POLICY "waste_logs_select" ON "public"."waste_logs" FOR SELECT USING ((("public"."get_my_role"() = 'super_admin'::"text") OR (("public"."get_my_role"() = ANY (ARRAY['owner'::"text", 'store_manager'::"text"])) AND ("restaurant_id" = "public"."get_my_restaurant_id"()))));

CREATE POLICY "waste_logs_select_today" ON "public"."waste_logs" FOR SELECT USING ((("public"."get_my_role"() = 'employee'::"text") AND ("restaurant_id" = "public"."get_my_restaurant_id"()) AND ("log_date" = CURRENT_DATE)));

CREATE POLICY "waste_logs_update_delete" ON "public"."waste_logs" USING ((("public"."get_my_role"() = ANY (ARRAY['super_admin'::"text", 'owner'::"text", 'store_manager'::"text"])) AND ("restaurant_id" = "public"."get_my_restaurant_id"()))) WITH CHECK ((("public"."get_my_role"() = ANY (ARRAY['super_admin'::"text", 'owner'::"text", 'store_manager'::"text"])) AND ("restaurant_id" = "public"."get_my_restaurant_id"())));
...
CREATE POLICY "stock_takes_select" ON "public"."stock_takes" FOR SELECT USING ((("public"."get_my_role"() = 'super_admin'::"text") OR (("public"."get_my_role"() = ANY (ARRAY['owner'::"text", 'store_manager'::"text", 'employee'::"text"])) AND ("restaurant_id" = "public"."get_my_restaurant_id"()))));
...
CREATE POLICY "stock_take_lines_delete_own" ON "public"."stock_take_lines" FOR DELETE USING ((("public"."get_my_role"() = 'employee'::"text") AND ("counted_by" = "auth"."uid"()) AND (EXISTS ( SELECT 1
   FROM "public"."stock_takes" "st"
  WHERE (("st"."id" = "stock_take_lines"."stock_take_id") AND (("st"."status")::"text" = 'in_progress'::"text"))))));

CREATE POLICY "stock_take_lines_insert_employee" ON "public"."stock_take_lines" FOR INSERT WITH CHECK ((("public"."get_my_role"() = 'employee'::"text") AND ("counted_by" = "auth"."uid"()) AND (EXISTS ( SELECT 1
   FROM "public"."stock_takes" "st"
  WHERE (("st"."id" = "stock_take_lines"."stock_take_id") AND ("st"."restaurant_id" = "public"."get_my_restaurant_id"()) AND (("st"."status")::"text" = 'in_progress'::"text"))))));

CREATE POLICY "stock_take_lines_select" ON "public"."stock_take_lines" FOR SELECT USING ((("public"."get_my_role"() = 'super_admin'::"text") OR (EXISTS ( SELECT 1
   FROM "public"."stock_takes" "st"
  WHERE (("st"."id" = "stock_take_lines"."stock_take_id") AND (("public"."get_my_role"() = ANY (ARRAY['owner'::"text", 'store_manager'::"text", 'employee'::"text"])) AND ("st"."restaurant_id" = "public"."get_my_restaurant_id"())))))));

CREATE POLICY "stock_take_lines_update_own" ON "public"."stock_take_lines" FOR UPDATE USING ((("public"."get_my_role"() = 'employee'::"text") AND ("counted_by" = "auth"."uid"()) AND (EXISTS ( SELECT 1
   FROM "public"."stock_takes" "st"
  WHERE (("st"."id" = "stock_take_lines"."stock_take_id") AND (("st"."status")::"text" = 'in_progress'::"text")))))) WITH CHECK ((("public"."get_my_role"() = 'employee'::"text") AND ("counted_by" = "auth"."uid"()) AND (EXISTS ( SELECT 1
   FROM "public"."stock_takes" "st"
  WHERE (("st"."id" = "stock_take_lines"."stock_take_id") AND (("st"."status")::"text" = 'in_progress'::"text"))))));

CREATE POLICY "stock_take_lines_write_manager" ON "public"."stock_take_lines" USING ((("public"."get_my_role"() = 'super_admin'::"text") OR (EXISTS ( SELECT 1
   FROM "public"."stock_takes" "st"
  WHERE (("st"."id" = "stock_take_lines"."stock_take_id") AND ("public"."get_my_role"() = ANY (ARRAY['owner'::"text", 'store_manager'::"text"])) AND ("st"."restaurant_id" = "public"."get_my_restaurant_id"()) AND (("st"."status")::"text" = 'in_progress'::"text")))))) WITH CHECK ((("public"."get_my_role"() = 'super_admin'::"text") OR (EXISTS ( SELECT 1
   FROM "public"."stock_takes" "st"
  WHERE (("st"."id" = "stock_take_lines"."stock_take_id") AND ("public"."get_my_role"() = ANY (ARRAY['owner'::"text", 'store_manager'::"text"])) AND ("st"."restaurant_id" = "public"."get_my_restaurant_id"()) AND (("st"."status")::"text" = 'in_progress'::"text"))))));
...
CREATE POLICY "roster_shifts_read_published" ON "public"."roster_shifts" FOR SELECT USING ((("published_at" IS NOT NULL) AND ("restaurant_id" = "public"."get_my_restaurant_id"())));

ALTER TABLE "public"."day_notes" ENABLE ROW LEVEL SECURITY;

CREATE POLICY "day_notes_select" ON "public"."day_notes" FOR SELECT USING ((("public"."get_my_role"() = 'super_admin'::"text") OR ("restaurant_id" = "public"."get_my_restaurant_id"())));

CREATE POLICY "day_notes_write" ON "public"."day_notes" USING ((("public"."get_my_role"() = 'super_admin'::"text") OR (("public"."get_my_role"() = ANY (ARRAY['owner'::"text", 'store_manager'::"text"])) AND ("restaurant_id" = "public"."get_my_restaurant_id"())))) WITH CHECK ((("public"."get_my_role"() = 'super_admin'::"text") OR (("public"."get_my_role"() = ANY (ARRAY['owner'::"text", 'store_manager'::"text"])) AND ("restaurant_id" = "public"."get_my_restaurant_id"()))));

ALTER TABLE "public"."absences" ENABLE ROW LEVEL SECURITY;

CREATE POLICY "absences_all" ON "public"."absences" USING ((("public"."get_my_role"() = 'super_admin'::"text") OR (("public"."get_my_role"() = ANY (ARRAY['owner'::"text", 'store_manager'::"text"])) AND ("restaurant_id" = "public"."get_my_restaurant_id"())))) WITH CHECK ((("public"."get_my_role"() = 'super_admin'::"text") OR (("public"."get_my_role"() = ANY (ARRAY['owner'::"text", 'store_manager'::"text"])) AND ("restaurant_id" = "public"."get_my_restaurant_id"()))));

CREATE POLICY "absences_ask_own" ON "public"."absences" FOR INSERT WITH CHECK ((("employee_id" = "public"."get_my_employee_id"()) AND ("restaurant_id" = "public"."get_my_restaurant_id"()) AND ("status" = 'requested'::"text") AND ("kind" = ANY (ARRAY['holiday'::"text", 'day_off'::"text"]))));

CREATE POLICY "absences_read_own" ON "public"."absences" FOR SELECT USING (("employee_id" = "public"."get_my_employee_id"()));

CREATE POLICY "absences_withdraw_own" ON "public"."absences" FOR DELETE USING ((("employee_id" = "public"."get_my_employee_id"()) AND ("status" = 'requested'::"text")));

ALTER TABLE "public"."shift_requests" ENABLE ROW LEVEL SECURITY;

CREATE POLICY "shift_requests_answer" ON "public"."shift_requests" FOR UPDATE USING ((("public"."get_my_role"() = 'super_admin'::"text") OR (("restaurant_id" = "public"."get_my_restaurant_id"()) AND (("public"."get_my_role"() = ANY (ARRAY['owner'::"text", 'store_manager'::"text"])) OR ("from_employee_id" = "public"."get_my_employee_id"()) OR ("to_employee_id" = "public"."get_my_employee_id"()))))) WITH CHECK ((("restaurant_id" = "public"."get_my_restaurant_id"()) OR ("public"."get_my_role"() = 'super_admin'::"text")));

CREATE POLICY "shift_requests_ask" ON "public"."shift_requests" FOR INSERT WITH CHECK ((("restaurant_id" = "public"."get_my_restaurant_id"()) AND ("from_employee_id" = "public"."get_my_employee_id"())));

CREATE POLICY "shift_requests_read" ON "public"."shift_requests" FOR SELECT USING ((("public"."get_my_role"() = 'super_admin'::"text") OR ("restaurant_id" = "public"."get_my_restaurant_id"())));
...
CREATE POLICY "weekly_reports_select" ON "public"."weekly_reports" FOR SELECT USING ((("public"."get_my_role"() = 'super_admin'::"text") OR (("public"."get_my_role"() = ANY (ARRAY['owner'::"text", 'store_manager'::"text"])) AND ("restaurant_id" = "public"."get_my_restaurant_id"()))));

CREATE POLICY "weekly_reports_write" ON "public"."weekly_reports" USING ((("public"."get_my_role"() = 'super_admin'::"text") OR (("public"."get_my_role"() = 'store_manager'::"text") AND ("restaurant_id" = "public"."get_my_restaurant_id"())))) WITH CHECK ((("public"."get_my_role"() = 'super_admin'::"text") OR (("public"."get_my_role"() = 'store_manager'::"text") AND ("restaurant_id" = "public"."get_my_restaurant_id"()))));
...
CREATE POLICY "report_sections_select" ON "public"."report_sections" FOR SELECT USING ((EXISTS ( SELECT 1
  ...
  WHERE (("r"."id" = "report_sections"."report_id") AND (("public"."get_my_role"() = 'super_admin'::"text") OR (("public"."get_my_role"() = ANY (ARRAY['owner'::"text", 'store_manager'::"text"])) AND ("r"."restaurant_id" = "public"."get_my_restaurant_id"())))))));

CREATE POLICY "report_sections_write" ON "public"."report_sections" USING ((EXISTS ( SELECT 1
   FROM "public"."weekly_reports" "r"
  WHERE (("r"."id" = "report_sections"."report_id") AND (("public"."get_my_role"() = 'super_admin'::"text") OR (("public"."get_my_role"() = 'store_manager'::"text") AND ("r"."restaurant_id" = "public"."get_my_restaurant_id"()))))))) WITH CHECK ((EXISTS ( SELECT 1
   FROM "public"."weekly_reports" "r"
  WHERE (("r"."id" = "report_sections"."report_id") AND (("public"."get_my_role"() = 'super_admin'::"text") OR (("public"."get_my_role"() = 'store_manager'::"text") AND ("r"."restaurant_id" = "public"."get_my_restaurant_id"())))))));
...
CREATE POLICY "report_items_select" ON "public"."report_items" FOR SELECT USING ((EXISTS ( SELECT 1
  ...
  WHERE (("s"."id" = "report_items"."section_id") AND (("public"."get_my_role"() = 'super_admin'::"text") OR (("public"."get_my_role"() = ANY (ARRAY['owner'::"text", 'store_manager'::"text"])) AND ("r"."restaurant_id" = "public"."get_my_restaurant_id"())))))));

CREATE POLICY "report_items_write" ON "public"."report_items" USING ((EXISTS ( SELECT 1
   FROM ("public"."report_sections" "s"
     JOIN "public"."weekly_reports" "r" ON (("r"."id" = "s"."report_id")))
  WHERE (("s"."id" = "report_items"."section_id") AND (("public"."get_my_role"() = 'super_admin'::"text") OR (("public"."get_my_role"() = 'store_manager'::"text") AND ("r"."restaurant_id" = "public"."get_my_restaurant_id"()))))))) WITH CHECK ((EXISTS ( SELECT 1
   FROM ("public"."report_sections" "s"
     JOIN "public"."weekly_reports" "r" ON (("r"."id" = "s"."report_id")))
  WHERE (("s"."id" = "report_items"."section_id") AND (("public"."get_my_role"() = 'super_admin'::"text") OR (("public"."get_my_role"() = 'store_manager'::"text") AND ("r"."restaurant_id" = "public"."get_my_restaurant_id"())))))));
...
CREATE POLICY "events_select" ON "public"."events" FOR SELECT USING (("public"."get_my_role"() = ANY (ARRAY['super_admin'::"text", 'owner'::"text", 'store_manager'::"text"])));

CREATE POLICY "events_select_all_staff" ON "public"."events" FOR SELECT USING (("public"."get_my_role"() IS NOT NULL));

CREATE POLICY "events_write" ON "public"."events" USING (("public"."get_my_role"() = ANY (ARRAY['super_admin'::"text", 'owner'::"text", 'store_manager'::"text"]))) WITH CHECK (("public"."get_my_role"() = ANY (ARRAY['super_admin'::"text", 'owner'::"text", 'store_manager'::"text"])));
...
CREATE POLICY "login_events_select" ON "public"."login_events" FOR SELECT USING (("public"."get_my_role"() = 'super_admin'::"text"));

ALTER TABLE "public"."change_log" ENABLE ROW LEVEL SECURITY;

CREATE POLICY "change_log_select" ON "public"."change_log" FOR SELECT USING (("public"."get_my_role"() = 'super_admin'::"text"));
