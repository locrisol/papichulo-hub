  ...
  return (
    ...
    <aside className="w-56 bg-sidebar flex flex-col flex-shrink-0">
        <div className="px-5 py-7 border-b border-sidebar-active">
          ...
          <p className="text-xs text-green-400 mt-1 tracking-widest uppercase">Point Campus</p>
        </div>
              ...
              {navItems.filter(n => n.section === section).map(item => {
                ...
                return (
                  <button
                    ...
                    className={`w-full flex items-center gap-3 px-5 py-2.5 text-sm font-medium transition-colors border-r-4 ${
                      isActive
